...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary/90 shadow-soft hover:shadow-cool",
        destructive:
        ...
        hero: "bg-gradient-cool text-primary-foreground hover:scale-105 shadow-cool hover:shadow-2xl font-semibold",
        cta: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-cool hover:shadow-2xl hover:scale-105 font-semibold",
